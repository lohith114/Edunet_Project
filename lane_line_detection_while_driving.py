# -*- coding: utf-8 -*-
"""Lane_line_detection_while_driving.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1_H7C20N3ycvZTEXNDOdgMmODME3p6FXr
"""
...
fig = plt.figure(figsize=(20, 10))
image = mpimg.imread('/content/highway.png')
...
output_path = '/content/processed_subclip.mp4'

# Commented out IPython magic to ensure Python compatibility.
white_output = '/content/solidWhiteRightt.mp4'
...
white_output = '/content/solidWhiteRightt.mp4'  # Replace with the actual file path

# Display the video
video_display = Video(white_output, embed=True, width=960, height=500)
display(video_display)

# Commented out IPython magic to ensure Python compatibility.
yellow_output = '/content/solidYellowLeftt.mp4'
## To speed up the testing process you may want to try your pipeline on a shorter subclip of the video
## To do so add .subclip(start_second,end_second) to the end of the line below
## Where start_second and end_second are integer values representing the start and end of the subclip
## You may also uncomment the following line for a subclip of the first 5 seconds
...
# Specify the path to your video file
yellow_output = '/content/solidYellowLeftt.mp4' # Replace with the actual file path

# Display the video
video_display = Video(yellow_output, embed=True, width=960, height=500)
display(video_display)
